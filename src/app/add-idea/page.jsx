    ...
    return (
      <div className="w-full max-w-3xl mx-auto py-8">
        <div className="border border-zinc-200 dark:border-zinc-800 shadow-xl bg-white dark:bg-zinc-900 rounded-3xl p-8 text-center">
          ...
          <p className="text-sm font-bold text-zinc-900 dark:text-white mb-4">Please log in to register custom concepts inside the archive context.</p>
          <button onClick={() => router.push("/login")} className="h-11 px-6 bg-blue-600 text-white text-xs font-bold rounded-xl cursor-pointer">
            Log In
          </button>
        </div>
      </div>
      ...
      <div className="border border-zinc-200 dark:border-zinc-800 shadow-xl bg-white dark:bg-zinc-900 rounded-3xl p-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-12 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl mt-2 shadow-lg shadow-blue-600/10 transition-colors flex items-center justify-center text-sm disabled:opacity-50 cursor-pointer"
          >
